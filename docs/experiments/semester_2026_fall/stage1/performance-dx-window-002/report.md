# performance-dx-window-002

Status: passed

All operands are identical FP32 fixtures; errors use independent FP64 loop references. Max relative error uses denominator max(abs(reference), 1e-8).
